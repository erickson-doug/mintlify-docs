...
flowchart TB
  ...
  subgraph COMPEXEC["Compile + execute"]
    direction TB
    C1["Neuron Graph Compiler<br>neuronx-cc for Inf2 and Trainium<br>neuron-cc for Inf1 legacy"]
  ...
  subgraph HARDWARE["Kernel driver + hardware"]
    ...
    D4["Trn1 / Trn2 / Trn3<br>NeuronCores v2 / v3 / v4"]
    D1 --> D2
    D1 --> D3
    D1 --> D4
  end
...
flowchart LR
  ...
  STACK["Every layer"]
  DR["Driver + runtime"]
  ALL["Complete SDK + frameworks"]
  AUTHOR["Kernel authors + developers"]
