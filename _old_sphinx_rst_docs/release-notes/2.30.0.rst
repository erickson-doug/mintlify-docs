.. _neuron-2-30-0-whatsnew:
.. _latest-neuron-release:

.. meta::
   :description: The official release notes for the AWS Neuron SDK, version 2.30.0. Release date: 05/21/2026.

AWS Neuron SDK 2.30.0 release notes
===================================
...
This page provides detailed component release notes for the Neuron SDK 2.30.0. For a an overview of the release content, see :ref:`What's New in AWS Neuron <whats-new-2026-05-21-v2_30>`.
...
Select a card below to review detailed release notes for each component of the Neuron SDK version 2.30.0. These component release notes contain details on specific new and improved features, as well as breaking changes, bug fixes, and known issues for that component area of the Neuron SDK.
...
.. grid:: 1 
        ...
        .. grid-item-card:: 
                ...
                **PyTorch Neuron (torch-neuronx)** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **NxD Inference** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **Neuron Kernel Interface (NKI)** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **NKI Library (NKI-Lib)** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **Neuron Runtime** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **Neuron Developer Tools** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **Neuron Deep Learning AWS Machine Images (DLAMIs)** 2.30.0 release notes
                ^^^
        ...
        .. grid-item-card:: 
                ...
                **Neuron Deep Learning Containers (DLCs)** 2.30.0 release notes
                ^^^
