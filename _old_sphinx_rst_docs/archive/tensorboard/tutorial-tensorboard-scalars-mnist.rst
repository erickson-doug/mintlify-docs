...
.. meta::
   :noindex:
   :nofollow:
   :description: Archived tutorial for tracking MNIST training progress in TensorBoard using PyTorch Neuron. End of support in Neuron 2.29. Use Neuron Explorer instead.
   :date-modified: 2026-05-11

Track Training Progress in TensorBoard using PyTorch Neuron (archived)
=======================================================================

.. warning::

   This tutorial is archived. The Neuron plugin for TensorBoard reached end
   of support. This tutorial is provided for reference only and is no longer
   maintained.

   Use :ref:`Neuron Explorer <neuron-explorer-home>` for current profiling
   and analysis workflows. See the :ref:`Neuron Explorer FAQ
   <neuron-explorer-faq>` for migration guidance.
