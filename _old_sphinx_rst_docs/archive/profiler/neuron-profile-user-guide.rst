...
.. meta::
   :noindex:
   :nofollow:
   :description: Archived user guide for the Neuron Profiler (neuron-profile). End of support in Neuron 2.29. Use Neuron Explorer instead.
   :date-modified: 2026-05-11

Neuron Profiler User Guide (archived)
=====================================

.. warning::

   This document is archived. The **Neuron Profiler** (``neuron-profile``)
   reached end of support in Neuron 2.29. It is provided for reference only
