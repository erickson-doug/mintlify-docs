...
.. meta::
   :noindex:
   :nofollow:
   :description: Archived user guide for Neuron Profiler 2.0 (Beta). End of support in Neuron 2.29. Use Neuron Explorer instead.
   :date-modified: 2026-05-11

Neuron Profiler 2.0 (Beta) User Guide (archived)
================================================

.. warning::

   This document is archived. **Neuron Profiler 2.0 (Beta)** reached end of
   support in Neuron 2.29. It is provided for reference only and is no longer
   maintained.
