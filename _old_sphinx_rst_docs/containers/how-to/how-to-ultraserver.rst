...
* Neuron Device Plugin installed on the cluster with version >= 2.26.26.0 (:ref:`k8s-neuron-device-plugin`)
...
- :ref:`k8s-neuron-device-plugin` - Information about Neuron Device Plugin
